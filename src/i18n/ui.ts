...
export const ui = {
  uz: {
    ...
    'services.instagram.forWhom': 'Do\'konlar, xizmatlar, onlayn kurslar uchun',
    'services.instagram.result': 'Sotuvni 2-3 barobar oshirish, yangi mijozlar',
    'services.instagram.price': '1 500 000 so\'m/oydan',
    'services.telegram.what': 'Telegram kanallar va Telegram Ads orqali reklama qilamiz',
    'services.telegram.forWhom': 'Kurslar, eventlar, kanal egalar uchun',
    'services.telegram.result': 'Obunachi va sotuvlarni ko\'paytirish',
    'services.telegram.price': '1 000 000 so\'m/oydan',
    'services.google.what': 'Googleda sizni qidirayotgan odamlarga reklama ko\'rsatamiz',
    'services.google.forWhom': 'Xizmatlar, B2B kompaniyalar uchun',
    'services.google.result': 'Tayyor mijozlarni jalb qilish',
    'services.google.price': '2 000 000 so\'m/oydan',
  ...
  en: {
    ...
    'services.instagram.what': 'Show your ads to specific audience - by age, location, interests',
    'services.instagram.forWhom': 'For shops, services, online courses',
    'services.instagram.result': 'Increase sales 2-3x, new customers',
    'services.instagram.price': 'From $120/month',
    'services.telegram.what': 'Advertise through Telegram channels and Telegram Ads',
    'services.telegram.forWhom': 'For courses, events, channel owners',
    'services.telegram.result': 'Increase subscribers and sales',
    'services.telegram.price': 'From $80/month',
    'services.google.what': 'Show ads to people searching for you on Google',
    'services.google.forWhom': 'For services, B2B companies',
    'services.google.result': 'Attract ready-to-buy customers',
    'services.google.price': 'From $150/month',
  ...
  ru: {
    ...
    'services.instagram.what': 'Показываем рекламу целевой аудитории - по возрасту, месту, интересам',
    'services.instagram.forWhom': 'Для магазинов, услуг, онлайн-курсов',
    'services.instagram.result': 'Увеличение продаж в 2-3 раза, новые клиенты',
    'services.instagram.price': 'От 1 500 000 сум/мес',
    'services.telegram.what': 'Реклама через Telegram-каналы и Telegram Ads',
    'services.telegram.forWhom': 'Для курсов, мероприятий, владельцев каналов',
    'services.telegram.result': 'Увеличение подписчиков и продаж',
    'services.telegram.price': 'От 1 000 000 сум/мес',
    'services.google.what': 'Показываем рекламу тем, кто ищет вас в Google',
    'services.google.forWhom': 'Для услуг, B2B компаний',
    'services.google.result': 'Привлечение готовых клиентов',
    'services.google.price': 'От 2 000 000 сум/мес',
