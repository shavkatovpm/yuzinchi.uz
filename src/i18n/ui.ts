...
export const ui = {
  uz: {
    ...
    'services.instagram.forWhom': 'Do\'konlar, salonlar, restoranlar, kurslar, xizmatlar uchun.',
    'services.instagram.result': 'Sotuvlar 2-3x oshadi. Har 1 so\'mga 3-5 so\'m qaytadi.',
    ...
    'services.telegram.forWhom': 'Kurslar, kanal egalar, IT, eventlar, yangiliklar uchun.',
    'services.telegram.result': 'Obunachi va sotuvlar tez o\'sadi. Aniq statistika.',
    ...
    'services.google.forWhom': 'Xizmatlar, B2B, mahalliy bizneslar uchun.',
    'services.google.result': 'Tayyor mijozlar. Yuqori konversiya.',
  ...
  en: {
    ...
    'services.instagram.forWhom': 'Stores, salons, restaurants, courses, services.',
    'services.instagram.result': 'Sales increase 2-3x. $3-5 return per $1 spent.',
    'services.instagram.price': 'From $120/month',
    'services.telegram.what': 'Telegram Ads and popular channels. Lead collection bots.',
    'services.telegram.forWhom': 'Courses, channels, IT, events, news portals.',
    'services.telegram.result': 'Subscribers and sales grow fast. Detailed stats.',
    'services.telegram.price': 'From $80/month',
    'services.google.what': 'Ads for people searching for you. First in search results.',
    'services.google.forWhom': 'Services, B2B, local businesses.',
    'services.google.result': 'Ready customers. High conversion.',
  ...
  ru: {
    ...
    'services.instagram.forWhom': 'Магазины, салоны, рестораны, курсы, услуги.',
    'services.instagram.result': 'Продажи растут в 2-3 раза. 3-5 сум на каждый вложенный.',
    ...
    'services.telegram.forWhom': 'Курсы, каналы, IT, события, порталы.',
    'services.telegram.result': 'Подписчики и продажи растут быстро. Точная статистика.',
    'services.telegram.price': 'От 1 000 000 сум/мес',
    'services.google.what': 'Реклама для тех, кто вас ищет. Первые в поиске.',
    'services.google.forWhom': 'Услуги, B2B, локальный бизнес.',
    'services.google.result': 'Готовые клиенты. Высокая конверсия.',
