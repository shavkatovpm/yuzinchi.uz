...
export const ui = {
  uz: {
    ...
    'services.instagram.target.title': 'Instagram Target',
    'services.instagram.target.desc': 'Aniq maqsadli auditoriyaga yo\'naltirilgan reklama - yoshi, joylashuvi, qiziqishlari bo\'yicha',
    'services.instagram.reels.title': 'Instagram Reels',
    'services.instagram.reels.desc': 'Viral video kontent orqali brendingizni millionlab foydalanuvchilarga yetkazing',
    'services.telegram.ads.title': 'Telegram Ads',
    'services.telegram.ads.desc': 'Rasmiy Telegram Ads platformasi orqali keng auditoriyaga reklama',
    'services.telegram.channels.title': 'Telegram Kanallar',
    'services.telegram.channels.desc': 'Mashhur kanallarda to\'g\'ridan-to\'g\'ri reklama joylash xizmati',
    'services.google.search.title': 'Google Search',
    'services.google.search.desc': 'Qidiruv natijalarida birinchi o\'rinlarda chiqish - mijoz qidirganda topilasiz',
    'services.google.display.title': 'Google Display',
    'services.google.display.desc': 'Banner reklamalar orqali millionlab saytlarda brendingizni ko\'rsating',
  ...
  en: {
    ...
    'services.instagram.target.title': 'Instagram Target',
    'services.instagram.target.desc': 'Targeted advertising to specific audiences - by age, location, interests',
    'services.instagram.reels.title': 'Instagram Reels',
    'services.instagram.reels.desc': 'Reach millions of users with viral video content for your brand',
    'services.telegram.ads.title': 'Telegram Ads',
    'services.telegram.ads.desc': 'Advertising to a wide audience through the official Telegram Ads platform',
    'services.telegram.channels.title': 'Telegram Channels',
    'services.telegram.channels.desc': 'Direct ad placement service in popular channels',
    'services.google.search.title': 'Google Search',
    'services.google.search.desc': 'Appear at the top of search results - be found when customers search',
    'services.google.display.title': 'Google Display',
    'services.google.display.desc': 'Show your brand on millions of websites through banner ads',
  ...
  ru: {
    ...
    'services.instagram.target.title': 'Instagram Target',
    'services.instagram.target.desc': 'Таргетированная реклама на конкретную аудиторию - по возрасту, местоположению, интересам',
    'services.instagram.reels.title': 'Instagram Reels',
    'services.instagram.reels.desc': 'Донесите ваш бренд до миллионов пользователей с помощью вирусного видеоконтента',
    'services.telegram.ads.title': 'Telegram Ads',
    'services.telegram.ads.desc': 'Реклама широкой аудитории через официальную платформу Telegram Ads',
    'services.telegram.channels.title': 'Telegram Каналы',
    'services.telegram.channels.desc': 'Услуга прямого размещения рекламы в популярных каналах',
    'services.google.search.title': 'Google Search',
    'services.google.search.desc': 'Появляйтесь на первых позициях в результатах поиска - будьте найдены когда клиенты ищут',
    'services.google.display.title': 'Google Display',
    'services.google.display.desc': 'Показывайте ваш бренд на миллионах сайтов через баннерную рекламу',
