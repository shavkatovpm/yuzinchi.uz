...
export const ui = {
  uz: {
    ...
    'services.instagram.title': 'Instagram Reklama',
    'services.instagram.desc': 'Target reklama orqali potensial mijozlaringizga to\'g\'ridan-to\'g\'ri yetib boramiz',
    'services.telegram.title': 'Telegram Reklama',
    'services.telegram.desc': 'O\'zbekistonda eng faol auditoriyaga ega platformada reklama',
    'services.google.title': 'Google Reklama',
    'services.google.desc': 'Mahsulot yoki xizmat qidirayotgan mijozlarni topamiz',
  ...
  en: {
    ...
    'services.instagram.title': 'Instagram Advertising',
    'services.instagram.desc': 'We reach your potential customers directly through targeted advertising',
    'services.telegram.title': 'Telegram Advertising',
    'services.telegram.desc': 'Advertising on the platform with the most active audience in Uzbekistan',
    'services.google.title': 'Google Advertising',
    'services.google.desc': 'We find customers who are searching for your product or service',
  ...
  ru: {
    ...
    'services.instagram.title': 'Реклама в Instagram',
    'services.instagram.desc': 'Достигаем ваших потенциальных клиентов напрямую через таргетированную рекламу',
    'services.telegram.title': 'Реклама в Telegram',
    'services.telegram.desc': 'Реклама на платформе с самой активной аудиторией в Узбекистане',
    'services.google.title': 'Реклама в Google',
    'services.google.desc': 'Находим клиентов, которые ищут ваш продукт или услугу',
